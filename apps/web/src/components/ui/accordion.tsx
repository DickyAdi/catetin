...
>(({ className, ...props }, ref) => (
  <details ref={ref} className={cn("group border-b border-hairline", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <div ref={ref} className={cn("pb-lg text-body-small text-ink-muted", className)} {...props}>
    {children}
  </div>
));
